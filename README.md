...
- **It taps you on the shoulder** — a macOS notification, titled with the card name, the moment an agent finishes (DONE) or stops for approval (BLOCKED), so Fleet doesn't have to stay in front of you. Click it and you land in that card's terminal. Nothing fires for a card whose terminal you already have open. Each kind can be toggled off in Settings.
